...
<div class="min-h-full">
    <nav class="bg-gray-800"  x-data="{ isOpen: false }">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="size-12" src="img/images.png" alt="Your Company">
            </div>
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/karyawan" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Data Karyawan</a>
                <a href="/create" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Input Data</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
              ...
              <div class="relative ml-3">
                <div>
                  ...
                  class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-8 rounded-full" src="img/mancing.png" alt="">
                  </button>
                </div>
      ...
      <div x-show="isOpen"class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/karyawan" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Data Karyawan</a>
          <a href="/create" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Input Data</a>
        </div>
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="img/mancing.png" alt="">
            </div>
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Dimas Dewandaru Sebastian</div>
              <div class="text-sm font-medium text-gray-400">dimasbatian1717@gmail.com</div>
            </div>
          </div>
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
       <p>Selamat Datang Di Web Site Kami, Web Site Ini Berisikan Data Karyawan Yang Ada Di PT SSM Silahkan Masuk Ke Halaman Data Karyawan Untuk Melihat Data Karyawan Yang Ada Di PT SSM</p>
